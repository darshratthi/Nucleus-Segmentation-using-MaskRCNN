...
ROOT1=os.path.join(ROOT_DIR,"skc")
print('ROOT1'+ROOT1)
...
COCO_WEIGHTS_PATH = os.path.join(ROOT1, "mask_rcnn_coco.h5")

DEFAULT_LOGS_DIR = os.path.join(ROOT1, "nucleus\logs")

RESULTS_DIR = os.path.join(ROOT1, "nucleus\results\nucleus")
...
class NucleusDataset(utils.Dataset):
    ...
    def load_nucleus(self, dataset_dir, subset):
        ...
        assert subset in ["train", "val", "stage1_test"]
